...
/* DEFS: readonly int nSleep;
 */
extern int nSleep;
#ifndef CK_TEMPLATES_ONLY
extern "C" void __xlater_roPup_nSleep(void *_impl_pup_er) {
  PUP::er &_impl_p=*(PUP::er *)_impl_pup_er;
  _impl_p|nSleep;
}
#endif /* CK_TEMPLATES_ONLY */
...
void _registermain(void)
{
  ...
  CkRegisterReadonly("nSleep","int",sizeof(nSleep),(void *) &nSleep,__xlater_roPup_nSleep);
